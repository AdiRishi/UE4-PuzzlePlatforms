...
void APuzzlePlatformsCharacter::BeginPlay()
{
	...
	if (this->HasAuthority()) {
		GEngine->AddOnScreenDebugMessage(0, 15, FColor::Magenta, TEXT("Actor Has Authority"));
	}
	else {
		GEngine->AddOnScreenDebugMessage(0, 15, FColor::Magenta, TEXT("Actor Does NOT have Authority"));
	}

	switch (this->GetNetMode()) {
	case ENetMode::NM_Client:
		GEngine->AddOnScreenDebugMessage(1, 15, FColor::Magenta, TEXT("ActorNetMode is CLIENT"));
		break;
	case ENetMode::NM_ListenServer:
		GEngine->AddOnScreenDebugMessage(1, 15, FColor::Magenta, TEXT("ActorNetMode is LISTEN SERVER"));
		break;
	case ENetMode::NM_DedicatedServer:
		GEngine->AddOnScreenDebugMessage(1, 15, FColor::Magenta, TEXT("ActorNetMode is Dedicated Server"));
		break;
	case ENetMode::NM_Standalone:
		GEngine->AddOnScreenDebugMessage(1, 15, FColor::Magenta, TEXT("ActorNetMode is STANDALONE"));
		break;
	}
}
